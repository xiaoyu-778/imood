...
| 类型         | 说明             | 示例模型                   |
| ------------ | ---------------- | -------------------------- |
| **文本对话** | 纯文本输入输出   | GPT-4, Claude, Qwen, Llama |
| **流式响应** | SSE 实时输出     | 大多数现代模型             |
| **语音输入** | 接收音频文件     | Whisper API, Qwen-Audio    |
| **语音输出** | 返回音频 URL     | TTS API, Qwen-Omni         |
| **图片理解** | 分析图片内容     | GPT-4V, Qwen-VL            |
| **全模态**   | 同时支持以上所有 | Qwen-Omni, GPT-4o          |
...
| OpenAI | gpt-4o          | 功能全面，质量最高 |

### 纯文本对话

| 提供商   | 模型          | 特点             |
| -------- | ------------- | ---------------- |
| DeepSeek | deepseek-chat | 中文理解优秀     |
| 月之暗面 | moonshot-v1   | 长文本支持好     |
| 硅基流动 | Qwen2.5 系列  | 开源，可本地部署 |
